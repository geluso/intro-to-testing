...
if(typeof window.jstag !== 'object'){
    ...
    var initObj = {
        "cid": "4274e8ad322ec51d773bcb674ad26d77",
        "url": "https://api.lytics.io" || "https://c.lytics.io",
        "synchronous":true,
        "min": false
    };
...
var ly_cid = "4274e8ad322ec51d773bcb674ad26d77";
...
(function(d, w) {
  ...
  w.lio = {
    account: {
      id: "4274e8ad322ec51d773bcb674ad26d77"
    },
    loaded: false,
    ...
    getEntity: function(payload){
      ...
      // make the request
      // technically it is not possible to support a truly syncronous tag since we dynamically load pathfora, personalization configs, etc.
      // will remove this eventually as right now this is either breaking accounts or being defaulted to async anyway
      if(w.lio.sync){
